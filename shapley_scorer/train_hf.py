...
class HF_Trainer:
    ...
    def train(self,
              ...
              epochs):
        logging.set_verbosity_warning()
        print(f"{STEP} learning rate: {learning_rate}, batch size: {batch_size}, epochs: {epochs} {ENDC}")
        ...
        if last_checkpoint_folder is not None:
            ...
            print(f"Model saved in: {last_checkpoint_path}")
    ...
    def hyperparameter_search(self, 
        ...
        for i in range(num_trials):
            ...
            print(f"{STEP} Trial {i}: {hyperparameters} {ENDC}")
            accuracy = self.train(
        ...
        print(f"{STEP} Best hyperparameters: {best_hyperparameters}")
        print(f"Best metric: {best_accuracy} {ENDC}")
